		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zfiflujoaprobacion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfiflujoaprobacion-display": {
								"semanticObject": "zfiflujoaprobacion",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfiflujoaprobacion",
									"url": sap.ui.require.toUrl("zfiflujoaprobacion")
								}
							}
						}
					}
